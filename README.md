...
## 👨‍💻 Process & Role
#### Overall Process
###### - 기획, 서버구현, 프론트구현, 모델학습, PPT제작, 발표, 데이터수집, 디자인
#### 😺 My Role

- 기획
    - 어플리케이션의 전체적인 기능과 구현을 기획
- 서버구현
    - Python Flask를 이용하여 서버 구현
    - 구현한 서버에서 리액트 네이비브로 데이터 전송
...
- 모델학습
    ...
    - MediaPipe를 이용하여 keypoint 추출 후 정규화
    - 정규화한 X, Y, 정확도를 색상 좌표로 변환
- PPT제작
    - PPT 전체적인 틀 제작
    - PPT 전체적인 내용 입력
- 데이터수집
    - AI허브에 수어 데이터셋을 찾고 googledrive에 업로드
- 디자인
    - 어플리케이션 전체적으로 디자인
...
### **발표ppt**
[어울림 ppt](https://github.com/dev-aram/Eoullim/blob/master/%EC%96%B4%EC%9A%B8%EB%A6%BC.pdf)
